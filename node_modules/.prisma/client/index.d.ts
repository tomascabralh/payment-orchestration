...
export namespace Prisma {
  ...
  */
  ...
  export type PaymentOrderOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"uuid" | "amount" | "description" | "countryIsoCode" | "createdAt" | "paymentUrl" | "providers", ExtArgs["result"]["paymentOrder"]>
  ...
  export interface PaymentOrderDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const paymentOrderWithUuidOnly = await prisma.paymentOrder.findMany({ select: { uuid: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many PaymentOrders and only return the `uuid`
     * const paymentOrderWithUuidOnly = await prisma.paymentOrder.createManyAndReturn({
     *   select: { uuid: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more PaymentOrders and only return the `uuid`
     * const paymentOrderWithUuidOnly = await prisma.paymentOrder.updateManyAndReturn({
     *   select: { uuid: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface PaymentOrderFieldRefs {
    readonly uuid: FieldRef<"PaymentOrder", 'String'>
    readonly amount: FieldRef<"PaymentOrder", 'Float'>
    readonly description: FieldRef<"PaymentOrder", 'String'>
    readonly countryIsoCode: FieldRef<"PaymentOrder", 'String'>
    readonly createdAt: FieldRef<"PaymentOrder", 'DateTime'>
    readonly paymentUrl: FieldRef<"PaymentOrder", 'String'>
    readonly providers: FieldRef<"PaymentOrder", 'Json'>
  }
  ...
  export type PaymentOrderWhereInput = {
    ...
    uuid?: StringFilter<"PaymentOrder"> | string
    amount?: FloatFilter<"PaymentOrder"> | number
    description?: StringFilter<"PaymentOrder"> | string
    countryIsoCode?: StringFilter<"PaymentOrder"> | string
    createdAt?: DateTimeFilter<"PaymentOrder"> | Date | string
    paymentUrl?: StringFilter<"PaymentOrder"> | string
    providers?: JsonFilter<"PaymentOrder">
  }
  ...
  export type PaymentOrderScalarWhereWithAggregatesInput = {
    ...
    uuid?: StringWithAggregatesFilter<"PaymentOrder"> | string
    amount?: FloatWithAggregatesFilter<"PaymentOrder"> | number
    description?: StringWithAggregatesFilter<"PaymentOrder"> | string
    countryIsoCode?: StringWithAggregatesFilter<"PaymentOrder"> | string
    createdAt?: DateTimeWithAggregatesFilter<"PaymentOrder"> | Date | string
    paymentUrl?: StringWithAggregatesFilter<"PaymentOrder"> | string
    providers?: JsonWithAggregatesFilter<"PaymentOrder">
  }
  ...
  export type PaymentOrderCreateInput = {
    ...
    paymentUrl: string
    providers?: JsonNullValueInput | InputJsonValue
  }
